...
FeaturedVideosModel featuredVideosModelFromJson(String str) => FeaturedVideosModel.fromJson(json.decode(str));

String featuredVideosModelToJson(FeaturedVideosModel data) => json.encode(data.toJson());
...
class FeaturedVideosModel {
  ...
  factory FeaturedVideosModel.fromJson(Map<String, dynamic> json) => FeaturedVideosModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    videoCategoryId: json["video_category_id"] == null ? null : json["video_category_id"],
