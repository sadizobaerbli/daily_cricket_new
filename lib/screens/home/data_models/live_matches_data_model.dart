...
LiveMatchesDataModel liveMatchesDataModelFromJson(String str) => LiveMatchesDataModel.fromJson(json.decode(str));

String liveMatchesDataModelToJson(LiveMatchesDataModel data) => json.encode(data.toJson());
...
class LiveMatchesDataModel {
  ...
  factory LiveMatchesDataModel.fromJson(Map<String, dynamic> json) => LiveMatchesDataModel(
