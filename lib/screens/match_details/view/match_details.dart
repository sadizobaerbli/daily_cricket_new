...
class _MatchDetailsState extends State<MatchDetails> {
  ...
  _oneSideScoreboard(){
    return Column(
      ...
      children: [
        Center(
          child: Text('Bangladesh'.toUpperCase(),
            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: Text('Batsman'.toUpperCase(),
                    style: boldText(fontSize: 10.sp, color: BasicWhite),),
                ),
              ),
              SizedBox(width: 26.w,),
              Container(
                height: 19.h, width: 28.w,
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(16.r),
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Sakib Al Hasan',
                            style: boldText(fontSize: 12.sp, color: PrimaryDeepGreen),),
                          SizedBox(height: 4.h,),
                          Text('c James Weighell b A Salter',
                            style: semiBoldText(fontSize: 8.sp,),)
                        ],
                      ),
                    ),
                    SizedBox(width: 28.w,),
        ...
        Padding(
          ...
          child: Row(
            children: [
              Container(
                height: 19.h, width: 69.w,
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(16.r),
                    color: PrimaryGreen
                ),
                child: Center(
                  child: Text('Extras'.toUpperCase(),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Center(
                  child: Text("Didn't bat".toUpperCase(),
                    style: semiBoldText(fontSize: 10.sp, color: BasicWhite),
                  ),
                ),
              ),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(left: 15.sp, top: 4.h),
                  child: Text('Bowlers'.toUpperCase(),
                    style: boldText(fontSize: 10.sp, color: BasicWhite),),
                ),
              ),
              SizedBox(width: 26.w,),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(left: 15.sp, top: 4.h),
                  child: Text('W Falls'.toUpperCase(),
                    style: boldText(fontSize: 10.sp, color: BasicWhite),),
                ),
              ),
              SizedBox(width: 12.w,),
              Container(
                height: 19.h, width: 48.w,
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(16.r),
                    color: Grey.withOpacity(.4)
                ),
        ...
        Padding(
          ...
          child: Row(
            children: [
              Container(
                height: 19.h, width: 72.w,
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(16.r),
                  color: Grey.withOpacity(.5),
                ),
                child: Center(
                  child: Text("Powerplay".toUpperCase(),
                    style: semiBoldText(fontSize: 10.sp, color: BasicWhite,),
                  ),
                ),
              ),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Center(
                  child: Text("mandatory".toUpperCase(),
                    style: semiBoldText(fontSize: 10.sp, color: BasicWhite,),
                  ),
                ),
              ),
              SizedBox(width: 24.w,),
              Center(
                child: Text("0.1-6.0".toUpperCase(),
                  style: semiBoldText(fontSize: 10.sp,),
                ),
              ),
              SizedBox(width: 44.w,),
              Center(
                child: Text("206".toUpperCase(),
                  style: semiBoldText(fontSize: 10.sp,),
                ),
              ),
            ],
