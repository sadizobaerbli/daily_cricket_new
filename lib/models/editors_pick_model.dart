...
EditorsPickModel EditorsPickModelFromJson(String str) =>
    EditorsPickModel.fromJson(json.decode(str));

String EditorsPickModelToJson(EditorsPickModel data) =>
...
class EditorsPickModel {
  ...
  factory EditorsPickModel.fromJson(Map<String, dynamic> json) =>
      EditorsPickModel(
        data: json["data"] == null
            ? null
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        photoCredit: json["photo_credit"] == null
            ? null
            : photoCreditValues.map[json["photo_credit"]],
        reporter: json["reporter"] == null
            ? null
            : reporterValues.map[json["reporter"]],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "photo_credit": photoCredit == null
            ? null
            : photoCreditValues.reverse![photoCredit],
...
final photoCreditValues = EnumValues({"Online": PhotoCredit.ONLINE});

enum Reporter { STAFF_CORRESPONDENT }

final reporterValues =
    EnumValues({"Staff Correspondent": Reporter.STAFF_CORRESPONDENT});
